<template>
  ...
  <div>
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="block">
              <!-- <div class="title"><strong>Data Table</strong></div> -->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                        ...
                        <select name='localidad_id' class="" v-model="cliente.localidad_id" :custom-label="nombreYCodigo" :options="localidades" placeholder="Buscar Localidad">
